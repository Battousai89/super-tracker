        ...
        <div class="center-block h-100 d-flex justify-content-center align-items-center">
            <form class="add-item-form m-auto align-content-center" @submit.prevent="submitForm">
                ...
                <label class="form-label w-100" for="description">
                    Описание <br/>
                    <textarea v-model="formData.description" class="w-100" name="description" type="text"/>
...
import Projects from "../components/ProjectsDashboard.vue";
</script>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post('/api/v1/projects', this.formData)
                .then(response => {
    ...
    components: Header, Footer, Projects
}
</script>
